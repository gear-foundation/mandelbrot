...
#[allow(dead_code)]
pub const RUSTC: &str = r"/Users/eugeneway/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"/Users/eugeneway/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/eugeneway/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.81.0-nightly (9c3bc805d 2024-06-27)";
#[doc=r#"The output of `/Users/eugeneway/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/eugeneway/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.81.0-nightly (9c3bc805d 2024-06-27)";
